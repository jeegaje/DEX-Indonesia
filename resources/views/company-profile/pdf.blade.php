...
<body class="bg-gray-200">
    ...
    <div class="bg-blue-800">
        ...
        <div class="bg-blue-800">
            <h1 class="text-center font-bold text-white">FORM MAINTENANCE SUBMERSIBLE AXIAL FLOW PUMP</h1>
        </div>
        <div class="flex gap-2 justify-center p-2 bg-gray-200">
            <div class="grid grid-cols-1 gap-2 text-xs">
                <div class="grid grid-cols-2 gap-2 items-center">
                    ...
                    <div class="">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white  bg-white">
            ...
            <div class="grid-cols-1 gap-2 text-xs p-0">
                ...
                <div class="p-2 flex flex-col gap-1">
                    ...
                    <div class="sm:col-span-4 flex gap-2 items-center justify-between">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="col-span-2 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white">
                                <input type="text" name="technician_team" id="technician_team"
                                    class="block flex-1 border-0 bg-transparent pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
                    ...
                    <div class="grid grid-cols-3">
                        <div class="flex rounded-md ring-gray-300 w-full">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="w-10">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white">
                                        <input type="text" name="technician_team" id="technician_team"
                                            class="block flex-1 border-0 bg-transparent pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
                ...
                <div class="grid-cols-1 col-span-2 gap-2 text-xs p-0">
                    ...
                    <div class="p-2 flex flex-col gap-1">
                        ...
                        <div class="flex gap-2 items-center justify-between">
                            ...
                            <div class="grid grid-cols-4 gap-1">
                                <div class="rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white w-16">
                                    <input type="text" name="technician_team" id="technician_team"
                                        class="block flex-1 border-0 bg-transparent pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
            ...
            <div class="grid-cols-1 gap-2 text-xs p-0">
                ...
                <div class="p-2 flex flex-col gap-2">
                    ...
                    <div class="sm:col-span-4 flex gap-2 items-center justify-between">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div
                                class="col-span-2 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white">
                                <input type="text" name="technician_team" id="technician_team"
                                    class="block flex-1 border-0 bg-transparent pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
                    ...
                    <div class="flex flex-col gap-2 text-xs items-center">
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            <div class="col-span-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 bg-white  bg-white">
                                    <input type="text" name="technician_team" id="technician_team"
                                        class="block flex-1 border-0 bg-transparent pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
